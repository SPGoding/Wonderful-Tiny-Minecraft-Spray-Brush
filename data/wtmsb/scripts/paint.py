...
image_data = ''
set_buffer = ''
text = 'data modify storage wtmsb: {{}} merge value {{{0:s}:[{1:s}]}}'
text2 = 'execute if score @s wtmsbType matches {:d} run data modify storage wtmsb: buffer set from storage wtmsb: {:s}'
count = 0
